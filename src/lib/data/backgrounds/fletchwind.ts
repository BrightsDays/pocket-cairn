    ...
    list: [
      {
        title: 'War',
        content:
          'If you are first to attack, your bow gains the blast property for the first round.',
        items: null,
        petty: null,
      },
      {
        title: 'Falconry',
        content:
          'You keep a falcon [3 hp, 5 STR, 16 DEX, 4 WIL, claws (d6+d6), bite (d6)]. It only eats live game.',
        items: null,
        petty: null,
        companions: [
          {
      ...
      },
      {
        title: 'Hunting',
        content:
          'When taking the Supply (pg. 80) action your ability to secure Rations increases by one step (e.g. 1d4 becomes 1d6).',
        items: null,
        petty: null,
      },
      {
        title: 'Tournaments',
        content:
          'Attacks with your bow are enhanced if the target is immobile.',
        items: null,
        petty: null,
      },
      {
        title: 'Training',
        content:
          'If you are the first to attack, melee attacks against you are impaired until you take STR damage.',
        items: null,
        petty: null,
      },
      {
        title: 'Scouting',
        content:
          'When taking the Travel (pg. 80) action, your presence decreases the chance of getting lost by one step (e.g. 4-in-6 becomes 3-in-6).',
        items: null,
        petty: null,
      },
    ],
